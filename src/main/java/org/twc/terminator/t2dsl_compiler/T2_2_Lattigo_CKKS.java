...
// clientSk)\n");
// append_idx("evaluator := ckks.NewEvaluator(params, rlwe.EvaluationKey{Rlk:
// rlk, Rtks: rotkey})\n");
// append_idx("var ptxt *rlwe.Plaintext\n");
// append_idx("tmp := make([]complex128, slots)\n");
// append_idx("ptxt = encoder.EncodeNew(tmp, params.MaxLevel(),
// params.DefaultScale(), slots)\n");
...
// append_idx("ptxt = encoder.EncodeNew(" + tmp_vec + ", params.MaxLevel(),
// params.DefaultScale(), slots)\n");
// append_idx("tmp_ = encryptorPk.EncryptNew(ptxt)\n");
...
// for (int i = 0; i < n.f4.size(); i++) {
// this.asm_.append("), 0),
// complex(float64(").append((n.f4.nodes.get(i).accept(this)).getName());
// }
// }
// this.asm_.append("), 0) }\n");
// append_idx("ptxt = encoder.EncodeNew(" + tmp_vec + ", params.MaxLevel(),
...
// this.asm_.append("), 0),
// complex(float64(").append((n.f7.nodes.get(i).accept(this)).getName());
// }
// }
// this.asm_.append("), 0) }\n");
// append_idx("ptxt = encoder.EncodeNew(" + tmp_vec + ", params.MaxLevel(),
...
// append_idx("fmt.Printf(\"%.1f\\n\", funits.Round(real(encoder.Decode(ptxt,
// slots)[0]), 2))\n");
// break;
// default:
...
// this.indent_ += 2;
// append_idx("fmt.Printf(\"%.1f \", funits.Round(real(" + tmp_vec + "[" +
// this.tmp_i +
// "]), 2))\n");
// this.indent_ -= 2;
// append_idx("}\n");
...
// return new Var_t("double", "float64(" + lhs.getName() + ")" + op +
// rhs.getName());
