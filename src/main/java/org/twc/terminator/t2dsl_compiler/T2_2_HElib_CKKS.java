...
// this.asm_.append(") = \" << fixed << setprecision(1) << real(tmp[0]) <<
// endl");
// break;
// default:
...
// append_idx(res_);
// this.asm_.append(" ").append(op).append("=
// (double)").append(lhs.getName()).append(";\n");
// break;
// case "-":
...
// case "-":
// this.asm_.append(" ").append(op).append("=
// (double)").append(rhs.getName()).append(";\n");
// break;
// case "^":
// throw new Exception("XOR over encrypted doubles is not possible");
// case "==":
...
// * f4 -> "]"
// */
// public Var_t visit(EncryptedArrayDoubleAllocationExpression n) throws
// Exception {
