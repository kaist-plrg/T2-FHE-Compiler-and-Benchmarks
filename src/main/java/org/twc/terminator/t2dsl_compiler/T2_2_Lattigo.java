...
// append_idx("// BFV parameters (128 bit security) with plaintext modulus
// 65929217\n");
...
// append_idx("}\n");
// append_idx("_ = rots\n");
// append_idx("rotkey := kgen.GenRotationKeysForRotations(rots, true,
// clientSk)\n");
// append_idx("evaluator := bfv.NewEvaluator(params, rlwe.EvaluationKey{Rlk:
// rlk, Rtks: rotkey})\n");
...
// append_idx(" \"github.com/tuneinsight/lattigo/v4/" +
// this.st_.backend_types.get("scheme")+ "\"\n");
...
// if (!(this.is_binary_ && (id_t.equals("EncInt") ||
// id_t.equals("EncDouble")))) {
// this.asm_.append(", ");
// }
// this.asm_.append(id.getName());
// return null;
...
// if (this.is_binary_ && (lhs_type.equals("EncInt") ||
// lhs_type.equals("EncInt[]"))) {
...
// append_idx(lhs.getName() + " = make([][]*rlwe.Ciphertext, len(" +
// lhs.getName() + "))\n");
// append_idx("for i := 0; i < len(" + lhs.getName() + "); i++ {\n");
// append_idx(" " + lhs.getName() + "[i] = make([]*rlwe.Ciphertext,
// word_sz)\n");
...
// break;
// case "<<=":
// append_idx(lhs.getName() + " = funits.BinShiftLeft(" + lhs.getName() + ", " +
// rhs.getName() + ")");
// break;
// case ">>=":
...
// } else {
// if ("*=".equals(op)) {
// append_idx(lhs.getName() + " = evaluator.MulScalarNew(");
...
// this.asm_.append(" }\n");
// append_idx("encoder.Encode(" + tmp_vec + ", ptxt)\n");
// append_idx(id.getName() + "[" + index.getName() + "] =
// encryptorSk.EncryptNew(ptxt)\n");
// }
// return null;
// }
//
...
// break;
// case "*":
// append_idx(res_ + " := evaluator.MulScalarNew(" + rhs.getName());
// this.asm_.append(", uint64(").append(lhs.getName()).append("))\n");
// break;
// case "-":
...
// break;
// case "*":
// append_idx(res_ + " := evaluator.MulScalarNew(" + lhs.getName());
// this.asm_.append(", uint64(").append(rhs.getName()).append("))\n");
// break;
// case "-":
